...
import { getAllUsers, getUserById, getAllEvents, createEvent, updateEvent, deleteEvent, getAllBookings, getBookingById, deleteBooking, generateSeats } from "../controllers/AdminController.js";
...
AdminRouter.post("/generate-seats", generateSeats);
